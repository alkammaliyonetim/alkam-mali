(function(){
'use strict';
var VERSION='ALKAM Tek Kontrol Rozeti v9.6 stable';
...
function render(){
  ...
  var html='<span>'+s.label+'</span><small>'+s.detail+'</small>';
  if(b.className!==s.status)b.className=s.status;
