...
Sıradaki gerçek adım canlı sitede tek parça final test komutunu çalıştırmaktır.
```
...
## Tek Parça Final Test Dosyası

```text
ALKAM_V12_TEK_PARCA_CANLI_TEST_KOMUTU.md
```

Bu dosyadaki komut canlı sitede console'a tek parça halinde yapıştırılır.
...
Preflight decision: v12 stabilizasyonuna geçilebilir
writeOpen: false
exportBad: false
writeAllowed: false
liveFailed: 0
