# ALKAM Mali - v12 Tek Parça Canlı Test Komutu

Bu dosya canlı sitede console'a tek blok halinde yapıştırılacak final test komutunu içerir.
...
## Tek Parça Console Komutu

Aşağıdaki blok canlı sitede tarayıcı console'una yapıştırılır.
...
Bu komut veri yazmaz. Sadece mevcut modüllerin test fonksiyonlarını çalıştırır ve sonucu console'a döker.
