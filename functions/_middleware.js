...
<style id="alkam-international-ui-polish-style">
  ...
  .alkam-report-standard .main{padding-top:0!important;padding-left:18px!important;padding-right:18px!important;padding-bottom:18px!important}
  .alkam-report-standard .erp-modulebar{height:56px!important;margin-bottom:12px!important;padding-left:18px!important;padding-right:18px!important}
  .alkam-report-standard .topbar{margin-bottom:10px!important;gap:10px!important;align-items:flex-start!important}
  .alkam-report-standard .page-head h1{margin:0!important;line-height:1.08!important}
  .alkam-report-standard .page-head p{margin-top:5px!important;line-height:1.35!important}
  .alkam-report-standard .cards{gap:12px!important;margin-bottom:12px!important;align-items:stretch!important}
  .alkam-report-standard .card{padding:14px!important}
  .alkam-report-standard .section{padding:14px!important;margin-bottom:12px!important}
  .alkam-report-standard .section-title{margin-bottom:10px!important;line-height:1.18!important}
  .alkam-report-standard .grid-2,.alkam-report-standard .grid-3{gap:12px!important}
  .alkam-report-standard .grid-4{gap:10px!important}
  .alkam-report-standard .toolbar,.alkam-report-standard .filter-chips,.alkam-report-standard .account-actions{margin-bottom:10px!important;gap:8px!important}
  .alkam-report-standard .list{gap:8px!important}.alkam-report-standard .list-item{padding:11px!important}.alkam-report-standard .empty{padding:16px!important}.alkam-report-standard .metric-mini{padding:10px!important}
  .alkam-summary-polished{padding:12px!important;display:flex!important;flex-direction:column!important;gap:8px!important;min-height:96px!important;background:#fff!important;border:1px solid var(--alkam-report-line)!important;border-radius:12px!important;box-shadow:0 8px 20px rgba(15,23,42,.045)!important}
  ...
  .alkam-summary-pairs{display:grid!important;grid-template-columns:1fr 1fr!important;gap:7px!important;align-items:stretch!important}
  .alkam-summary-pair{border:1px solid #edf2f7!important;background:var(--alkam-report-soft)!important;border-radius:9px!important;padding:8px 9px!important;min-width:0!important}
  .alkam-summary-pair-label{display:block!important;font-size:10px!important;font-weight:950!important;color:var(--alkam-report-muted)!important;line-height:1.2!important;margin-bottom:4px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
  .alkam-summary-pair-value{display:block!important;font-size:16px!important;font-weight:950!important;color:var(--alkam-report-text)!important;line-height:1.12!important;font-variant-numeric:tabular-nums!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
  ...
  .alkam-fin-card{padding:12px!important;border-radius:11px!important;border:1px solid var(--alkam-report-line)!important;background:#fff!important;box-shadow:0 6px 18px rgba(15,23,42,.04)!important;min-height:80px!important;display:flex!important;flex-direction:column!important;gap:6px!important}
  ...
  .alkam-fin-head{align-items:flex-start!important;border:1px solid var(--alkam-report-line)!important;background:#fff!important;border-radius:13px!important;padding:13px!important;margin-bottom:10px!important;box-shadow:0 8px 22px rgba(15,23,42,.04)!important}
  .alkam-fin-title{font-size:20px!important;margin:0 0 4px!important;line-height:1.2!important}
  .alkam-fin-sub{font-size:12px!important;color:var(--alkam-report-muted)!important;font-weight:750!important;line-height:1.42!important}
  .alkam-fin-cards{gap:10px!important;margin-bottom:10px!important}
  .alkam-fin-table-wrap{border:1px solid var(--alkam-report-line)!important;border-radius:11px!important;overflow:auto!important;background:#fff!important}
  .alkam-fin-table th,.alkam-fin-table td{padding:8px 8px!important;vertical-align:top!important}
  ...
  .alkam-fin-note{font-size:11px!important;color:#475569!important;background:#fbfdff!important;border-radius:11px!important;line-height:1.45!important;margin-top:10px!important;padding:9px!important}
  .alkam-fin-actions{gap:7px!important;align-items:center!important}.alkam-fin-actions input,.alkam-fin-actions button{height:34px!important;border-radius:8px!important;font-size:12px!important}
  ...
  @media(max-width:900px){.alkam-report-standard .main{padding-left:12px!important;padding-right:12px!important}.alkam-report-standard .erp-modulebar{height:auto!important;min-height:52px!important;margin-bottom:10px!important;padding:8px 12px!important}.alkam-summary-pairs{grid-template-columns:1fr!important}.alkam-summary-pair-value{font-size:15px!important}.alkam-fin-card .v{font-size:16px!important}.alkam-fin-head{display:block!important}.alkam-fin-actions{margin-top:9px!important;display:grid!important;grid-template-columns:1fr!important}.alkam-fin-actions button,.alkam-fin-actions input{width:100%!important}}
</style>
...
(function(){
  ...
  function markReportAreas(){
    ...
    document.body.classList.add('alkam-density-balanced');
