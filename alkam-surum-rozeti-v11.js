(function(){
'use strict';
var VERSION='ALKAM Surum Rozeti v11.33 stable';
var BUILD='v11.33 - 06.05.2026';
function q(s,r){return (r||document).querySelector(s)}
function css(){if(q('#alkam-surum-rozeti-style'))return;var st=document.createElement('style');st.id='alkam-surum-rozeti-style';st.textContent='.alkam-version-badge{position:fixed;left:14px;bottom:14px;z-index:1000029;background:#0f172a;color:#fff;border:1px solid rgba(255,255,255,.16);box-shadow:0 18px 40px rgba(15,23,42,.25);border-radius:999px;padding:8px 12px;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:950;letter-spacing:.1px}.alkam-version-badge small{opacity:.72;margin-left:6px;font-weight:850}@media(max-width:900px){.alkam-version-badge{left:10px;bottom:72px;font-size:10px;padding:7px 10px}}@media print{.alkam-version-badge{display:none!important}}';document.head.appendChild(st)}
function render(){css();var el=q('#alkamVersionBadge');if(!el){el=document.createElement('div');el.id='alkamVersionBadge';el.className='alkam-version-badge';document.body.appendChild(el)}var html='ALKAM Mali <small>'+BUILD+'</small>';if(el.innerHTML!==html)el.innerHTML=html;window.__ALKAM_SURUM_ROZETI_LAST={version:VERSION,build:BUILD,visible:true,time:new Date().toISOString()};return window.__ALKAM_SURUM_ROZETI_LAST}
