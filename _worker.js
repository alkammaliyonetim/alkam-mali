export default {
  async fetch(request, env, ctx) {
    ...
    const scripts = ['alkam-cari-core-v4.js','alkam-last-amounts-v4g.js','alkam-data-quality-v1.js','alkam-tahakkuk-v5.js','alkam-tahakkuk-control-v5c.js','alkam-balance-highlight-v1.js','alkam-professional-ui-v1.js'].map((src)=>'<script src="/'+src+'"></script>').join('');
