export default {
  async fetch(request, env, ctx) {
    ...
    const scripts = ['alkam-reliability-guard-v1.js','alkam-cari-core-v4.js','alkam-last-amounts-v4g.js','alkam-data-quality-v1.js','alkam-tahakkuk-v5.js','alkam-tahakkuk-control-v5c.js','alkam-balance-highlight-v1.js','alkam-professional-ui-v1.js','alkam-finans-flow-v6.js','alkam-finans-ui-v6.js','alkam-tahsilat-v7.js','alkam-tahsilat-ui-v7.js','alkam-moka-ui-v6.js','alkam-banka-onay-v8.js','alkam-banka-onay-ui-v8.js','alkam-banka-import-ui-v8.js','alkam-banka-file-import-v8.js','alkam-banka-import-guard-v8.js'].map((src)=>'<script src="/'+src+'"></script>').join('');
